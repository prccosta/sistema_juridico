                                ...
                                <fieldset class="Literal">
                                   ...
                                   <table width="100%" Class="TextoNormal" >					
                                     ...
                                     <tr>
                                        ...
                                        if($execute=mysql_query("delete from `processo` WHERE id_processo = '$palavra'"))
											{
												echo"<script>alert('O PROCESSO FOI EXCLUÍDO COM SUCESSO!');
														window.location='pesquisarprocesso.php';
													</script>";
											}
                                        ?>
