		...
		<tr>
			<td background="img/fundo_admin.jpg" align="center" >
				<table width="100" cellpadding="0"  cellspacing="0" >
					...
					$sql = mysql_query("UPDATE parcela SET status_parcela = '2' where dtvenc < '$data' and status_parcela = '1'") or die(mysql_error());
											
											if($sql){
echo "<br><br><label class='Saudacao'><center>As parcelas foram setadas em atraso com sucesso!<br>Clique <a href='setaatraso.php'>Aqui</a> para voltar para página para Setar Parcelas em Atraso.</label>";

} else {
echo "<label class='Saudacao'><center>Ocorreu um erro durante a atualização!<br>Clique <strong><a href='setaatraso.php'>Aqui</a></strong> para voltar para página para Setar Parcelas em Atraso.</label>";
}
?>
