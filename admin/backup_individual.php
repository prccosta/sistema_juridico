				...
				<table width="100" cellpadding="0"  cellspacing="0" >
                    ...
                    <table width="100%" class="Borda1N" id="TABLE2" language="javascript" background="img/fundo.jpg">
                                    ...
                                    <table width="100%" Class="TextoNormal" >					
                                        <tr>
                                            <td align="center"><br><br>Seus dados foram copiados com sucesso na pasta BACKUP.<br>
                                              Todos os arquivos de backup individual se iniciam com db-backup-individual- e tem a extens&atilde;o .sql
                                              <br>
                                            <br>
						...
						function backup_tables($host,$user,$pass,$name,$tables = '*')
						{
						  ...
						  //save file
						  $handle = fopen('db-backup-individual-'.time().'.sql','w+');
						  
						  fwrite($handle,$return);
						  fclose($handle);
						  
						  	$ArqOrig = 'db-backup-individual-'.time().'.sql';
							$ArqDest = ('backup/db-backup-individual-'.time().'.sql');
						 
							//copio o arquivo para a pasta de destino
							copy($ArqOrig, $ArqDest);
							//apago o arquivo da pasta onde se encontra o arquivo backup_individual
							unlink($ArqOrig);
						}
						?>
