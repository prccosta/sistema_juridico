									...
									<form id="form1" action="backup_total.php" method="post" name="form1">
                                        <tr>
                                            <td><br>BACKUP TOTAL<br><br>
                                            	Clique no botão para fazer o backup de todos os dados. Esse procedimento pode demorar. Aguarde a página carregar totalmente.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!--<tr>
                                            <td>BACKUP INDIVDUAL<br><br>
                                            	Para fazer o backup de uma tabela específica, selecione a tabela
                                                ...
                                                e clique no botão para fazer a cópia dos dados.</td>
                                        </tr>
                                        <tr>
