                                        ...
                                        <tr>
                                            ...
                                            <td vAlign="middle" align="left"	>
                                             ...
                                             <?php
												...
												<form id='form1' name='form1' action='importa_remessa.php' method='post'>
												<input name='arquivo_temp' type='hidden' id='arquivo_temp' value='remessa/".$_FILES["file"]["name"]."'><br><br>
												<input type='submit' id='importar' name='importar' class='Botao' value=' Importar Arquivo para a Base de Dados '></label>
												</form>";
												
												if (file_exists("remessa/" . $_FILES["file"]["name"]))
												{
