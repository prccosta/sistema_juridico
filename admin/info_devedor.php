			...
			$(function(){
				$("#add2").click(function(){
					var input = '<div class="itens2">';
						...
						input += '&nbsp;<label>Tipo: <select id="tipo_aluno" name="tipo_aluno[]" class="CampoTexto"><option>-- Escolha o Tipo --</option><option value="Residencial">Residencial</option><option value="Trabalho">Trabalho</option><option value="Celular">Celular</option><option value="Recado">Recado</option><option value="Recado">Fax</option></select></label>';
                        ...
                        <tr>
                            <td>
                                <fieldset class="Literal">
                                    ...
                                    <form id="form1" action="sql_info_devedor.php" method="post" name="form1">					
                                    <?php
                                        ...
                                        <td vAlign='middle' align='left'>
                                            <table class='TextoNormal' width='100%'>
                                                <tr>
                                                    ...
                                                    <td width='80%'>
													<input type='hidden' name='id_devedor' class='CampoTexto' value='".$res['id_devedor']."'>
													<input type='text' name='nome' class='CampoTexto' value='".$res['nome_dev']."'></td>
                                                </tr>
                                                <tr>
                                                    <td>CPF:
                                                    </td>
                                                    <td width='80%'><input type='text' name='cpf' class='CampoTexto' value='".$res['cpf']."'></td>
                                                </tr>
                                                <tr>
                                                    <td>Responsável:
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width='80%'><input type='text' name='cpf_responsavel' class='CampoTexto' value='".$res['cpf_responsavel']."'></td>
                                                </tr>
												...
												$sql2=mysql_query("SELECT * FROM aluno_devedor WHERE id_devedor = '$palavra'") or die (mysql_error());
													if (mysql_num_rows($sql2)){
													while($res2=mysql_fetch_array($sql2)){
                                                    $id_tel_devedor = $res2['id_tel_devedor'];
													echo "<table width='400' class='TextoNormal'>
													  <td>Matrícula:</td>
                                                      <td><nobr>
													  <input type='hidden' name='id_tel_devedor' class='CampoTexto' value='".$res2['id_tel_devedor']."'>
													  <input type='text' name='matricula_aluno[]' class='CampoTexto' Width='40px' value='".$res2['matricula']."'></td>
                                                      <td >Nome:</td>
                                                      <td style='width: 103px'><nobr><input type='text' name='nome_aluno[]' class='CampoTexto' value='".$res2['nome']."'></td>
                                                      <td>
													...
													echo "<br><table><tr><td><input type='button' class='Botao4' id='add_campos' onclick='document.form3.submit();' width='86' height='18'><br><br></td></tr>";
												
												$sql3=mysql_query("SELECT * FROM telefone_devedor WHERE id_devedor = '$palavra'") or die (mysql_error());
													if (mysql_num_rows($sql3)){
													while($res3=mysql_fetch_array($sql3)){
                                                    $id_tel_devedor = $res3['id_tel_devedor'];
													echo "<table width='400' class='TextoNormal'>
													  <td width='92'>DDD:</td>
                                                      <td width='33'><nobr>
													  <input type='hidden' name='id_tel_cliente' class='CampoTexto' value='".$res3['id_tel_devedor']."'>
													  <input type='text' name='ddd_aluno[]' class='CampoTextosemwidth' MaxLength='2' Width='40px' value='".$res3['ddd']."'></td>
                                                      <td >Tel:</td>
                                                      <td style='width: 103px'><nobr><input type='text' name='tel_aluno[]' class='CampoTexto' value='".$res3['telefone']."'></td>
                                                      <td width='1'>Tipo:</td>
                                                      <td ><select id='tipo_aluno' name='tipo_aluno[]' class='CampoTexto'>
                                                             <option>".$res3['tipo_tel']."</option>
											...
											<form id='form3' action='add_tel_devedor.php' method='post' name='form3'>
										    <input type='hidden' name='id_devedor' class='CampoTexto' value='".$palavra."'>
										    </form>
										    <form id='form2' action='sql_del_tel_devedor.php' method='post' name='form2'>
										    <input type='hidden' name='id_tel_devedor' class='CampoTexto' value='".$id_tel_devedor."'>
										   </form>";
											?>
                                        </td>
                                    </tr>
