                                ...
                                <fieldset class="Literal">
                                  <legend class="Literal">Informações Gerais</legend>
                                    ...
                                    <TR class="TextoTopo" align="center">
                                                ...
                                                <?php
														$_pagi_sql = "SELECT a.id_devedor, a.nome_dev, a.cidade, a.uf, 
														b.id_devedor, b.ddd, b.telefone
														FROM devedor as a
														LEFT JOIN telefone_devedor as b ON a.id_devedor = b.id_devedor
														WHERE nome_dev <> ''
														ORDER BY nome_dev";
														
														$_pagi_sql2 = "SELECT count(id_devedor) as total FROM devedor";
														...
														echo "<tr>
															...
															<td align='center'>".$res['ddd']."</td>
															<td align='center'>".$res['telefone']."</td>
															</tr>";
															}
															}
															...
															<b>ATÉ O MOMENTO EXISTEM ".$total_cliente." DEVEDORES.</b></td></tr>";
