                                    ...
                                    <tr>
                                        <td colspan="2" vAlign="top" >
                                          <table Class="TextoNormal" width="100%">
                                            ...
                                            <tr>
                                              <td width="50%">Nome:</td>
                                              <td width="80%"><input id="nome" name="nome" class="CampoTexto" list="devedores">
                                              <datalist id="devedores">
												<?php
												$sql_id_devedor = mysql_query("SELECT *
													FROM devedor");
												while($res_id_devedor = mysql_fetch_array($sql_id_devedor) ) {
                                                echo '<option value="'.$res_id_devedor['nome_dev'].'">'.$res_id_devedor['nome_dev'].'</option>';
                                                        }
												?>
                                              </datalist>
                                              </td>
                                            ...
                                            <tr>
                                              ...
                                              <td width="80%">
                                                <input id="id_cliente" name="id_cliente" class="CampoTexto" list="clientes">
                                                <datalist id="clientes">
													<?php
													$sql_id_cliente = mysql_query("SELECT * FROM cliente");
                                    ...
                                    <TR class="TextoTopo" align="center">
                                                ...
                                                <?php
													...
													if( $_SERVER['REQUEST_METHOD']=='POST' )  
														...
														$id_cliente_temp = getPost('id_cliente');  
														$id_cliente_x = explode(" - ",$id_cliente_temp);
														$id_cliente = $id_cliente_x[0];
													  
														if( $id_devedor ){ $where[] = " `id_devedor` like '%$id_devedor%'"; }  
														if( $nome ){ $where[] = " `nome_dev` like '%$nome%'"; }  
														if( $id_cliente ){ $where[] = " `id_cli_cliente` = '$id_cliente'"; }  
