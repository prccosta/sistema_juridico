                                        ...
                                        <tr>
                                            ...
                                            <td vAlign="middle" align="left"	>
                                                <table class="TextoNormal" width="100%" border="0">
                                                    <tr>
<?php
												$sql=mysql_query("DELETE FROM `remessa` WHERE `id_reg` = '|' OR `id_reg` = '9' OR `id_reg` = '0'");
												if($sql){
													echo "<br><br><label class='Saudacao'><center>A tabela REMESSA foi otimizada com sucesso!<br>Clique <a href='index.php'>Aqui</a> para voltar.</label>";
												} else {
													echo "<label class='Saudacao'><center>Ocorreu um erro durante a otimização!<br>Clique <strong><a href='index.php'>Aqui</a></strong> para voltar.</label>";
												}
