                                  ...
                                  <legend class="Literal">Informações Gerais</legend>
                                    ...
                                    <TR class="TextoTopo" align="center">
                                                ...
                                                <?php
														$_pagi_sql = "SELECT * 
														FROM usuarios as a
														LEFT JOIN ativo as b ON a.ativo = b.id_ativo
														LEFT JOIN nivel as c ON a.nivel = c.id_nivel
														ORDER BY nome";
														
														$_pagi_sql2 = "SELECT count(id) as total FROM usuarios";
														...
														echo "<tr>
															...
															<td align='center'>".$res['nome_nivel']."</td>
															<td align='center'>".$res['nome_ativo']."</td>
															</tr>";
															}
															}
															...
															<b>ATÉ O MOMENTO EXISTEM ".$total_cliente." USUÁRIOS.</b></td></tr>";
