			...
			<td background="img/fundo_admin.jpg" align="center" >
				<table width="100" cellpadding="0"  cellspacing="0" >
                    ...
                    <table width="100%" class="Borda1N" id="TABLE2" language="javascript" background="img/fundo.jpg">
                        <tr>
                            <td class="TextoTopo">
                                Resultado da Inclusão do Devedor</td>
                        </tr>
                        <tr>
                            <td>
                                   ...
                                   <table width="100%" Class="TextoNormal" >					
                                     ...
                                     <tr>
                                        ...
                                        <?php
											...
											if($sql){
echo "<br><br><label class='Saudacao'><center>O telefone do devedor foi cadastrado com sucesso!<br>Clique <a href='pesquisardevedor.php'>Aqui</a> para voltar para página de consulta.</label>";
} else {
echo "<label class='Saudacao'><center>Ocorreu um erro durante o cadastro!<br>Clique <strong><a href='pesquisardevedor.php'>Aqui</a></strong> para voltar para página de cadastro.</label>";
}
?>
