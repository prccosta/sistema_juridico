                                    ...
                                    <TR class="TextoTopo" align="center">
                                                ...
                                                <?php
													...
													if( $_SERVER['REQUEST_METHOD']=='POST' )  
														...
														if( $nome ){ $where[] = " `nome_vara` like '%$nome%'"; }  
													  
										$_pagi_sql = "SELECT * FROM vara";  
										if( sizeof( $where ) )
										...
										echo "<form name='form1' method='post' action='info_vara.php'><tr align='center'>
											<td><input type=image src='img/bt_editar.jpg' width='70' height='18'>
											<input name='id_vara' type='hidden' id='id_vara' value='".$res['id_vara']."'>
											</form></td>
											<td><input name='id_vara' type='text' id='id_vara' class='CampoPesquisa' size='15' readonly value='".$res['id_vara']."'></td>
											<td><input name='nome' type='text' id='nome' class='CampoPesquisa' readonly size='50' value='".$res['nome_vara']."'></td>
											<form name='form1' method='post' action='exclui_vara.php'>
											<input name='id_vara' type='hidden' id='id_vara' value='".$res['id_vara']."'>
