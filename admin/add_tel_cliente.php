                        ...
                        <tr>
                            <td>
                                <fieldset class="Literal">
                                    ...
                                    <form id="form1" action="sql_add_tel_cliente.php" method="post" name="form1">				
                                    <tr>
                                    	<?php
                                        ...
                                        <td vAlign='middle' align='left'>
                                            <table class='TextoNormal' width='100%'>
                                                <tr>
                                                    ...
                                                    <td width='80%' height='20'>".$res['nome_exib']."
													<input type='hidden' name='id_cliente' class='CampoTexto' value='".$res['id_cliente']."'></td>
                                                </tr>
                                                <tr>
                                                    <td>Telefone:</td>
                                                    <td width='80%'>
