			...
			<td background="img/fundo_admin.jpg" align="center" >
				<table width="100" cellpadding="0"  cellspacing="0" >
                    ...
                    <table width="100%" class="Borda1N" id="TABLE2" language="javascript" background="img/fundo.jpg">
                        <tr>
                            <td class="TextoTopo">
                                Atualização de Parcelas com Remessa</td>
                        </tr>
                        <tr>
                            <td>
                                <fieldset class="Literal">
                                    ...
                                    <tr>
                                        <td>
                                                <input type="submit" ID="btBaixaBoleto" value="Atualizar Tabela Parcela" class="Botao"><br><br>
                                                    <TR class="TextoTopo" align="center">
                                                    <TD width="10%">Parcela Atual</TD>
                                                    <TD width="20%">Número do Boleto</TD> 
                                                    <TD width="10%">Parcela Total</TD>
                                                    <TD width="10%">Vencimento</TD>
                                                    <TD width="10%">Valor</TD>
                                                    <TD width="10%">Status Parcela</TD> 
                                                    </TR>
							<?php
							$_pagi_sql = "SELECT *
								FROM `parcela` AS a
								...
								WHERE right(c.num_inscr,11) = b.cpf AND a.id_dev_devedor = b.id_devedor AND c.vltitulo = a.vlparcela
								ORDER BY a.dtvenc";
							
							$_pagi_result = mysql_query($_pagi_sql) or die (mysql_error());
							while($res2=mysql_fetch_array($_pagi_result)){
							echo "<tr align='center'>
										<input type='hidden' id='id_parcela' name='id_parcela' value='".$res2['id_parcela']."'>
										<td>".$res2['parcela_atual']."</td>
										<td>".$res2['numref']."</td>
										<td>".$res2['parcela_total']."</td>
