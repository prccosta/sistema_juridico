                        ...
                        <tr>
                            <td>
                                <fieldset class="Literal">
                                    ...
                                    <form id="form1" action="sql_setaatraso.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        <td>
                                                <input type="submit" ID="btSetaAtraso" value="Setar Atraso" class="Botao"><br><br>
                                                    ...
                                                    <TD width="20%">Devedor</TD>
                                                    <TD width="20%">ID | Nº Processo</TD> 
                                                    <TD width="5%">Nº Parcela</TD>
                                                    <TD width="10%">Tipo pagamento</TD>
							...
							$_pagi_sql = "SELECT *
							FROM processo as a
							LEFT JOIN parcela as b ON a.id_processo = b.id_proc_processo and b.dtvenc < '$data' and b.status_parcela = 1
							LEFT JOIN devedor as c ON a.devedor = c.id_devedor
							LEFT JOIN tipo_pagamento as d ON b.id_tipo_pagamento = d.id_pagamento
							WHERE a.id_processo = b.id_proc_processo and b.dtvenc < now() and b.status_parcela = 1
							ORDER BY b.dtvenc";
