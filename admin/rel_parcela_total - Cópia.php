...
<table width="100%" class="Borda1N" id="TABLE2" language="javascript" background="img/fundo.jpg">
                        <tr>
                            <td class="TextoTopo">
                                Relatório de Total de Parcelas por Devedor</td>
                        </tr>
                        <tr>
                            <td>
                                                 ...
                                                 <option value="0">-- Selecione o devedor --</option>
                                                    <?php
														...
														$sql_id_devedor = mysql_query("SELECT id_devedor, nome_dev
															from devedor where id_cli_cliente = $id_cliente order by nome_dev");
                                    ...
                                    <TR class="TextoTopo" align="center">
                                                ...
                                                <?php
													...
													if( $_SERVER['REQUEST_METHOD']=='POST' )  
														...
														$_pagi_sql = "SELECT a.devedor, a.id_processo, a.processo,
														b.parcela_atual, b.id_proc_processo, b.id_tipo_pagamento, b.vlparcela,
														b.dtvenc, c.nome_dev, d.nome_pag
														FROM parcela as b
														LEFT JOIN processo as a ON a.id_processo = b.id_proc_processo
														...
														echo "<tr align='center'>
															<td>".$res2['devedor']." | ".$res2['nome_dev']."</td>
															...
															<td colspan='3'><b>Total a Receber</b></td>
