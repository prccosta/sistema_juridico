                                ...
                                <fieldset class="Literal">
                                   ...
                                   <table width="100%" Class="TextoNormal" >					
                                     ...
                                     <tr>
										...
										$exibe = $_POST['exibe'];
                                        $execute=mysql_query("INSERT INTO `msg_processo` VALUES ('', '$id_processo', '$mensagem', $exibe)") or die(mysql_error());?>
                                        SUA MENSAGEM FOI GRAVADA COM SUCESSO!<br><br>
                                        CLIQUE <a href="pesquisarprocesso.php">aqui</a> PARA RETORNAR À PÁGINA DE PESQUISA.<br><br>
